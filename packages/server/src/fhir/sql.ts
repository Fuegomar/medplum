...
export function normalizeDatabaseError(err: any): OperationOutcomeError {
  ...
  switch (err?.code) {
    case PostgresError.UniqueViolation: // unique_violation
    ...
    case PostgresError.SerializationFailure: // serialization_failure
    ...
    case PostgresError.QueryCanceled: // query_canceled
    ...
    case PostgresError.InFailedSqlTransaction: // in_failed_sql_transaction
