...
CREATE FUNCTION token_array_to_text(text[])
    ...
    AS $function$SELECT e''||array_to_string($1, e'')||e''$function$;
...
CREATE UNIQUE INDEX "Coding_system_code_idx" ON "Coding" ("system", "code") INCLUDE ("id");
CREATE INDEX "Coding_system_display_idx" ON "Coding" USING gin ("system", display gin_trgm_ops);
...
CREATE UNIQUE INDEX "Coding_Property_coding_property_target_value_idx" ON "Coding_Property" ("coding", "property", "target", "value");
...
CREATE INDEX "Coding_Property_coding_idx" ON "Coding_Property" ("coding");
